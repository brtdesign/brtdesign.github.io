...
<section class="content__primary content-primary__multi-column">
   ...
   <h2 name="code">Code &amp; the critical rendering path</h2>
        ...
        <p>Overall page engagement improved dramatically, with the <strong>bounce rate dropping by over 50%</strong>; from around 23% of visits only viewing this single page, to (at the time of writing) averaging around 11%.</p>

        <p>Additionally,  a <strong>primary business goal</strong>, the number of users searching for their local group, <strong>increased by over 20%</strong> when comparing February 2014 to February 2015.</p>
